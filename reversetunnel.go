...
func NewReverseTunnel(ctx context.Context, local, remote Endpoint) Tunnel {
...
func (t *reverseTunnel) Close() (errs []error) {
	t.cancel()
...
func (t *reverseTunnel) Local() Endpoint {
	return t.local
}

func (t *reverseTunnel) Remote() Endpoint {
	return t.remote
}
